...
-- =====================
-- USER (Better Auth style + your fields)
-- =====================
...
CREATE INDEX IF NOT EXISTS idx_github_event_user_time ON "github_event"("userId", "occurred_at" DESC);
...
CREATE TRIGGER trg_repository_updatedAt
...
CREATE TRIGGER trg_repo_webhook_updatedAt
    BEFORE UPDATE ON "repo_webhook"
    FOR EACH ROW EXECUTE FUNCTION update_updatedAt_column();
